...
def test_parsing_result() -> None:
    ...
    assert parsed_news.article == re.sub(
        ...
        textwrap.dedent(
            ...
            王宇被關押近2年。 我在被非法綁架關押期間遭受酷刑折磨包括:(1)包括無數次電擊 (圖片
            、圖畫)(2)被吊拷在門上一個月時間:(圖畫)(3)長時間抻刑(圖畫)(4)被綁在鐵椅子上坐
            了三個月(圖畫) 對我的迫害很殘忍,對其他法輪功學員的迫害也很殘忍。我很難過,很悲傷,
            我決心一定要把這些邪惡公布出去,讓全世界的人們知道中共的邪惡!所以我決定在監獄中利
            用各種微型攝像機,拍攝中共的暴行。(圖片:微型攝像機、酷刑的油畫) (1)2008年,北京
            奧運會期間,我開始拍攝馬三家勞教所外景、內景、黑勞工,奴工平均每天超過12小時,最長
            24小時不休息。 (圖片、視頻) (2)2008年在馬三家勞教所,一名學員因在食堂說了一句「
            法輪大法好」被打成重傷。(圖片、視頻) (3)被迫害致死:路遠峰(64歲),被關押在本溪
            ...
            。 (圖片、視頻) 以上案例都是我親身的經歷並拍攝的案例。 這二十年來,我所熟悉的人中
