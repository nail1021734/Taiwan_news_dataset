...
def test_parsing_result() -> None:
    ...
    assert parsed_news.article == re.sub(
        ...
        textwrap.dedent(
            ...
            關鍵戰役中,只花了14分鐘就破門,替阿根廷點燃了晉級的希望,最後 在阿根廷首戰遭冰島1
            比1逼平後,梅西被拍到在第2戰面對克羅埃西亞賽前,眉頭深鎖還用手指按著額頭,神情看起
            ...
            ,才能確定是否可以晉級。 這一腳射門行雲流水,這是大家所熟悉的梅西,嬌小的身軀永遠
            比對手跑得更快,各種不可思議的動作在他身上看起來都很合理。這顆進球不僅讓他終結了
            ...
            容,他坦承過去這段時間非常痛苦, 雖然前2場都沒能贏下來,讓梅西遭致各種辱罵,但他仍
