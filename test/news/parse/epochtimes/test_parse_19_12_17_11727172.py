...
def test_parsing_result() -> None:
    ...
    assert parsed_news.article == re.sub(
        ...
        textwrap.dedent(
            ...
            共青團。我在此聲明我退出曾經加入過的少先隊,並與之劃清界限! 聲明人: 郭魏五 2019
            -12-16 08:23 北美 三退 看透中共邪教了。法輪功學員根本就沒做錯什麼啊,就這麼對待
            別人。看到整個共產邪教根本就是想著如何滅掉別人的自由,很邪惡,決定在這裡公開退出共匪
            黨團隊。 聲明人: 于在悉 2019-12-16 19:10 廣東 退出黨組織 本人杭州某銀行工作者
            ,今天明白中共對人民自身權利自由–特別是對法輪功的迫害,決定退出黨組織。 聲明人
            : 黃福來 2019-12-16 21:27 浙江舟山
            '''
        ),
    )
