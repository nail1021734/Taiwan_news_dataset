...
def test_parsing_result() -> None:
    ...
    assert parsed_news.article == re.sub(
        ...
        textwrap.dedent(
            ...
            「突破雷達」還吸引真鳥 西北工業大學從2011年開始著手研發「仿真間諜鳥」,可能
            足以突破雷達辨識,順利潛入敵後或重要據點收集情報,仿生的程度還足以吸引真鳥伴飛。
            據了解,「信鴿」重約200克、翼展約50公分,最大飛行時速可達40公里,最長續航時間為30
            分鐘,機上搭載高清攝影鏡頭、GPS、飛行控制系統和衛星通信數據鏈,特製的防震顫軟體,
            可以保證載機攝像頭的成像清晰度。 《甘肅》甘肅展開「紅旗河」考察 「藏
            水入甘」年調600億立方米 通過青藏高原邊緣繞行的調水路線「紅旗河」工程,近日已經有
            團隊在川滇藏進行實地勘察。該團隊由甘肅省社科院和中鐵集團研究院西北分院聯合組成
            的考察隊,目的是想了解「藏水入甘」的可行性。 《北京》雜交小麥豐產優勢明
            顯 比常規小麥增產20% 北京市農林科學院等科研團隊1992年發現小麥光溫敏雄性不育現象
            和材料,歷時20餘年堅持自主創新,創造出一批強優勢雜交小麥新組合,在國際上創立了「中
            國二系雜交小麥技術體系」。實驗證實,雜交小麥在豐產、節水、抗旱、耐貧脊等方面明顯
            優勢,與常規小麥相比,可增產20%以上,節水30%至50%,用種量減少30%以上。 《
            上海》比002航母廠房長200米! 江南造船廠「4號船塢」曝光 江南造船廠近日曝光了一組
            「4號船塢」外觀照,可以清楚看見搭配的大型龍門吊與部分施工的設備。值得注意的是,這
            個船塢除了是大陸第二艘自製航母的預定建造地之外,它的長度也十分驚人,來到了565公尺
            長,而作為參考,之前承建002航母的大連造船廠船塢長度僅有370公尺,兩者之間差了足足近
            兩百公尺。
            '''
        ),
    )
