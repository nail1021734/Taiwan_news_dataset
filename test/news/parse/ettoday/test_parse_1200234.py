...
def test_parsing_result() -> None:
    ...
    assert parsed_news.article == re.sub(
        ...
        textwrap.dedent(
            ...
            瑪莉愛狗協會、亞洲動物救援協會、巴克救援協會與行政院農業委員會動保處收容所。 為了
            讓更多人認識領養代替購買的美好,各位領養浪浪的愛心爸媽可以把認識自家毛小孩的經過、
            照顧後前後的轉變以及相處的趣事,投稿到公益年曆活動頁面,不僅有機會讓毛小孩成為年曆
            主角、獲得豐富好禮,更可能接受ETtoday寵物小組的採訪,透過ETtoday 超過1500萬粉絲
            的強大社群力量,廣泛地傳達關懷動物的理念!
            '''
        ),
    )
