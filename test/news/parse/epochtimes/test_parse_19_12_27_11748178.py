...
def test_parsing_result() -> None:
    ...
    assert parsed_news.article == re.sub(
        ...
        textwrap.dedent(
            ...
            (週二),陪您盤點年度大事件,歡歡喜喜迎新年。大紀元網站將進行網絡直播,請鎖定新聞
            直播間。 直播預告影片: 玩遍各國跨年景點 讓您目不轉睛 廚藝隨堂考 當家主播能否成為
            好廚娘 西遊慶新年 恭喜發財錢幣史 網紅齊聚秀才藝 新年第一夜 品嚐醫聖神奇的禦寒
            妙方 各國煙火跨國接力 一起倒數迎接2020新時代 新唐人電視台將在美東頻道、美中頻道
            、美西頻道、歐洲頻道、大陸頻道播出。 2019年12月31日(週二) 美東時間:21:00-00:
            15 美中時間:20:00-23:15 美西時間:18:00-21:15 2020年1月1日(週三) 歐洲時間:
            03:00-06:15 亞洲時間:10:00-13:15 美東頻道、美中頻道、美西頻道、歐洲頻道、亞
            太頻道
            '''
        ),
    )
