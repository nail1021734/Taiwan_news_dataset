...
# blocking us. Note that LTN and SET will ban us.
...
# is not blocking us. Note that LTN and SET will ban us.
...
def after_banned_sleep(company: str) -> None:
    ...
    if secs != 0.0:
        rand_secs = random.guass(mu=1, sigma=2)
